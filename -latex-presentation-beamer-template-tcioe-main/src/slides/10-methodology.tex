...
\begin{frame}{Methodology - [1] (System Block Diagram)}
    \begin{center}
        ...
        \resizebox{0.8\textwidth}{!}{%
            \input{src/images/page1.tex} % System Overview/Database Generation image
        }
        \par \small \textbf{System Block Diagram:} Overview of the database generation and matching pipeline.
    \end{center}
\end{frame}
...
\begin{frame}{Methodology - [4] (Flow Of Proposed System)}
    \begin{center}
        ...
        \resizebox{0.85\textwidth}{!}{%
            \input{src/images/page2.tex} % Skyline Extraction Flowchart
        }
        \par \small \textbf{Flowchart:} Pipeline from raw photo input to extracted skyline mask.
    \end{center}
\end{frame}
...
\begin{frame}{Methodology - [8] (Algorithm Architecture)}
    \begin{center}
        \vspace{1em}
        \resizebox{0.8\textwidth}{!}{%
            \input{src/images/page3.tex} % Matching Engine Diagram
        }
        \par \small \textbf{Algorithm Architecture:} Two-stage engine showing FFT-Sliding Window and DTW refinement.
    \end{center}
\end{frame}
