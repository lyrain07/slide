...
% scale=0.55 and transform shape ensures the entire diagram fits a standard slide width
\begin{tikzpicture}[
    ...
    \begin{scope}[yshift=0cm]
        ...
        % Tightened Simulated Imagery Block
    ...
    % ========================================================
    % 4. SHARED CENTRAL GRID (Positioned for the new 5.5cm spacing)
    % ========================================================
    \begin{scope}[shift={(23.2, 6.2)}]
        ...
        % Dynamic arrow paths adjusted for tighter layout
